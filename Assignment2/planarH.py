...
img1name = str(r'C:\SAI\IIIT\2019_Spring\Assignment2\heetesh\16-720B-Computer-Vision-master\Assignments\HW2\data\model_chickenbroth.jpg')
img2name = str(r'C:\SAI\IIIT\2019_Spring\Assignment2\heetesh\16-720B-Computer-Vision-master\Assignments\HW2\data\chickenbroth_04.jpg')
...
img_dst=cv2.warpPerspective(img2,finalH,(img1.shape[1],img1.shape[0]))
plt.axis('off')
