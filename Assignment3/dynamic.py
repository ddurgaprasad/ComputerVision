...
#image_1 = img[:, :width_cutoff]
#image_2 = img[:, width_cutoff:]

image_1=cv2.imread(r'Stereo Images\tsucuba_left.png')
image_2=cv2.imread(r'Stereo Images\tsucuba_right.png')
